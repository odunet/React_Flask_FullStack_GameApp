      ...
      return (
        <div className="Test">
          ...
          <div className = "li_footer" style={{"text-align": "center"}}>
            <li>Snake Game Powered by P5js &nbsp; &nbsp; &nbsp; <span><a href="/snake"><img src="./dist/images/p5.png" width='150px' height='100px'/></a></span></li>

            <li>Tic Tac Toe Powered by ReactJS<span><a href="/tictac"><img src="./dist/images/reac.png" width='150px' height='100px'/></a></span></li>
          </div>
